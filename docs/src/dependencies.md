...
VGI integrates several core libraries and components to provide its functionality.
Whilst requirements must be manually installed by the user of the library, dependencies are automatically downloaded by VGI.
