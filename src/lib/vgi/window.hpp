...
namespace vgi {
    ...
    struct layer {
        /// @brief Position of the top-left edge of the viewport used by the scene
        glm::vec2 viewport_origin{0.0f, 0.0f};
        /// @brief Size of the viewport used by the scene
        glm::vec2 viewport_size{1.0f, 1.0f};
        /// @brief Position of the top-left edge of the scissor used by the scene
        glm::vec2 scissor_origin{0.0f, 0.0f};
        /// @brief Size of the scissor used by the scene
        glm::vec2 scissor_size{1.0f, 1.0f};

        /// @brief Notifies the layer is being attached to a window
        /// @param win The window to which the layer is being attached
        virtual void on_attach(window& win) {}
        ...
        virtual void on_event(window& win, const SDL_Event& event) {}
        ...
        virtual void on_update(window& win, vk::CommandBuffer cmdbuf, uint32_t current_frame,
                               const timings& ts) {}
        ...
        virtual void on_detach(window& win) {}
    ...
    struct window : public system {
        ...
        inline vk::Format depth_texture_format() const noexcept { return this->depth_format; }
